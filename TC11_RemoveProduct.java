...
public class TC11_RemoveProduct {
...
WebDriver driver;
	...
	public void continueShoppinginCart() throws InterruptedException {
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("item_4_title_link")));
		
		WebElement item = driver.findElement(By.id("item_4_title_link"));
		System.out.println(item.getText()+" is removed from cart");
